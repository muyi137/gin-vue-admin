    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
          ...
          <el-button size="small" type="primary" icon="plus" :disabled="!multipleSelection.length" @click="beReview" >待审核</el-button> 
            <!-- <el-button size="small" type="primary" icon="plus" @click="openDialog">新增2</el-button> -->
        ...
        <el-table-column   label="操作" width="160">
            ...
            <!-- <el-button type="primary" link icon="edit" size="small" class="table-button" @click="ReviewedRow(scope.row,'待审核')">变更</el-button> -->
        ...
        <el-table-column sortable align="left" label="迟到早退天数" prop="cdzt" width="160" />
        <el-table-column sortable align="left" label="状态" prop="status" width="120" />
        <el-table-column sortable align="left" label="实际签到天数" prop="signed" width="140" />
...
// 全量引入格式化工具 请按需保留
import { getDictFunc, formatDate,formatDateTime, formatBoolean, filterDict } from '@/utils/format'
...
const beReview = async () => {
      ...
      multipleSelection.value &&
        multipleSelection.value.map(item => {
          ...
          const res = updateOaAttendance(formData.value)
          if (res.code === 0) {
            item.status = '待审核'
          }
