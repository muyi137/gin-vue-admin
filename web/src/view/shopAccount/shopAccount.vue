<template>
  <div>
        ...
        <el-form-item label="用户名">
          <el-input v-model="searchInfo.username" placeholder="搜索条件" />
           ...
           <el-form-item label="平台" prop="mall_id">
            <el-select v-model="searchInfo.mall_id" clearable placeholder="请选择" @clear="()=>{searchInfo.mall_id=undefined}">
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="平台" prop="mall_id" width="120">
        
            <template #default="scope">
            {{ filterDict(scope.row.mall_id,mallNameOptions) }}
            </template>
        </el-table-column>
        ...
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateAccountFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="平台:"  prop="mall_id" >
          <el-select v-model="formData.mall_id" placeholder="请选择" style="width:100%" :clearable="true" >
            <el-option v-for="(item,key) in mallNameOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item> 
      </el-form>
...
const onSubmit = () => {
  page.value = 1
  pageSize.value = 10 
  searchInfo.value.user_id = userStore.userInfo.ID
  getTableData()
}
