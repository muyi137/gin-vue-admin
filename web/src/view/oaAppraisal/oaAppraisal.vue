  ...
  <div>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        ...
        <el-upload class="excel-btn" :action="`${path}/oaAppraisal/importOaAppraisal`"
          :headers="{ 'x-token': userStore.token }" :on-success="getTableData" :show-file-list="false">
          <el-button size="small" type="primary" icon="upload" style="margin-left: 10px;">导入</el-button>
        </el-upload>
        <el-button class="excel-btn" size="small" type="primary" icon="download" @click="exportExc('教师绩效', 'table1')"
          style="margin-left: 10px;">导出</el-button>
        <el-button class="excel-btn" size="small" type="success" icon="download" @click="downloadExcelTemplate()">下载模板
        </el-button>
      </div>
      <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" id="table1" :data="tableData" row-key="ID"
        ...
        <el-table-column align="left" label="按钮组">
          <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button"
              @click="updateOaAppraisalFunc(scope.row)">变更</el-button>
      ...
      <div class="gva-pagination">
        <el-pagination layout="total, sizes, prev, pager, next, jumper" :current-page="page" :page-size="pageSize"
          :page-sizes="[20, 40, 80, 100, 9999999]" :total="total" @current-change="handleCurrentChange"
