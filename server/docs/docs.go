...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/notify/sendLinkMessage": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "发送图文链接消息的参数",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/response.LinkNotify"
                        }
                    }
                ],
                "responses": {
        ...
        "/notify/sendMarkdownMessage": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "发送markdown消息的参数",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/response.MarkdownNotify"
                        }
                    }
                ],
                "responses": {
        ...
        "/notify/sendTextMessage": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "发送文字消息的参数",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/response.TextNotify"
                        }
                    }
                ],
                "responses": {
        ...
        "/shopGoods/createShopGoods": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建ShopGoods",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/shop.ShopGoods"
                        }
                    }
                ],
                "responses": {
        ...
        "/shopGoods/deleteShopGoodsByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "response.MarkdownNotify": {
            "type": "object",
            "properties": {
                "atMobiles": {
                    "description": "需要艾特的人的手机号",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
